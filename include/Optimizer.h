...
public:
    ...
    void static FullInertialBAWithLines(Map *pMap, int its, const bool bFixLocal=false, const unsigned long nLoopKF=0, bool *pbStopFlag=NULL, bool bInit=false, float priorG = 1e2, float priorA=1e6, Eigen::VectorXd *vSingVal = NULL, bool *bHess=NULL);
    ...
    void static LocalBundleAdjustmentWithLine(KeyFrame *pKF, bool* pbStopFlag, Map* pMap, int& num_fixedKF, int& num_OptKF, int& num_MPs, int& num_edges);
    void static LocalBundleAdjustmentOnlyLine(KeyFrame* pKF, bool *pbStopFlag, Map *pMap, int& num_fixedKF, int& num_OptKF, int& num_MPs, int& num_edges);
    ...
    int static PoseInertialOptimizationLastFrameWithLines(Frame *pFrame, bool bRecInit = false);

    // visual-Inertial
    int static PoseInertialOptimizationLastKeyFrame(Frame* pFrame, bool bRecInit = false);
    int static PoseInertialOptimizationLastKeyFrameWithLines(Frame* pFrame, bool bRecInit = false);
    ...
    // add line opt
    void static LocalInertialBAWithLine(KeyFrame* pKF, bool *pbStopFlag, Map *pMap, int& num_fixedKF, int& num_OptKF, int& num_MPs, int& num_edges, bool bLarge = false, bool bRecInit = false);
