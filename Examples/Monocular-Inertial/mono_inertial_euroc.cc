...
//        std::cout<<"pathCam0:"<<pathCam0<<std::endl;
...
//    std::cout<<"Mono Inertial Euroc imageScale: "<<imageScale<<std::endl;
...
//            std::cout<<"image file name: "<<vstrImageFilenames[seq][ni]<<std::endl;
            im = cv::imread(vstrImageFilenames[seq][ni],cv::IMREAD_UNCHANGED); //CV_LOAD_IMAGE_UNCHANGED);

//            std::cout<<"Mono Inertial Euroc, imageHeight: "<<im.rows<<", imageWidth: "<<im.cols<<std::endl;
