...
public:
    ...
    void SaveManhTrajectoryEuRoC(const string &filename);
    void SaveManhKeyFrameTrajectoryEuRoC(const string &filename);
...
private:
    ...
    std::vector<line_descriptor::KeyLine> mTrackedKeyLinesUn;
