...
public:
    ...
    void SetManhWorldPose(const Sophus::SE3f &Tcm);

    Sophus::SE3f GetPose();

    Sophus::SE3f GetManhWorldPose();
    ...
    void SetBadFlagWithLine();

    // Compute Scene Depth (q=2 median). Used in monocular.
    float ComputeSceneMedianDepth(const int q);

    float ComputeSceneMaxDepth();
...
public:
    ...
    const cv::Mat mLineDescriptors, mLineDescriptorsFloat;
