...
namespace ORB_SLAM3 {
    ...
    public:
        ...
        int nLineFeatures() {return nLineFeatures_;}
        int nLineLevels() {return nLineLevels_;}
        int nLineExtractType() {return nLineExtractType_;}
        int nMinLineLength() {return nMinLineLength_;}
        int lineOptMethod() {return lineOptMethod_;}
        float lineScaleFactor() {return lineScaleFactor_;}
    ...
    private:
         ...
         */
        int nLineFeatures_;
        float lineScaleFactor_;
        int nLineLevels_;
        int nLineExtractType_;
        int nMinLineLength_;
        int lineOptMethod_;
