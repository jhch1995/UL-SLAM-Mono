...
public:
    ...
    void SetWorldManhAxis(const std::vector<Eigen::Vector3d>& worldManhAxis);
    void SetWorldManhFrame(const Frame& firstManhFrame);
    std::vector<Eigen::Vector3d> GetWorldManhAxis();
    ...
    std::vector<MapLine*> GetAllStructureMapLines();
...
protected:
    ...
    std::set<MapLine*> mspStructureMapLines;
    std::vector<Eigen::Vector3d> mWorldManhAxis;
    Frame mFirstManhFrame;
